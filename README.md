...
| 폰 접속 | 고정 허브 주소 1개 북마크 → 켜진 PC로 자동 연결 (여러 대면 카드 선택) |
| 워커 | 🪐 Antigravity(메인, 대화창 실시간 미러) · ⚡ Codex CLI · 🤖 Claude Code CLI (서브, 무인 데몬) |
| 콘솔 탭 | Antigravity / Codex / Claude Code / 파일·시스템 + 업로드 · 긴급 정지 · PC 전환 |
...
**B. 접속 — 폰에서 한 번**
5. 고정 허브 주소(북마크) 열기
6. 허브가 장부를 읽어 켜진 PC 1대면 0.5초 뒤 자동 이동, 여러 대면 PC 카드 선택
...
├── 1클릭_모바일콘솔_실행.bat   # 실행기 — 더블 클릭 한 번
